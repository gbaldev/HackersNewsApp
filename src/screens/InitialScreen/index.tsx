    ...
    <ScreenContainer
      ...
      <View style={styles.permissionRequestContiner}>
        ...
        <Text style={styles.paragraph}>
          {i.strings('initialScreen.firstLine')}
        </Text>
        <Text style={styles.paragraph}>
          {i.strings('initialScreen.secondLine')}
        </Text>
        <Text style={styles.paragraph}>
          {i.strings('initialScreen.thirdLine')}
        </Text>
        <Text style={styles.paragraph}>
          {i.strings('initialScreen.fourthLine')}
        </Text>
        <Text style={styles.paragraph}>
          {i.strings('initialScreen.fifthLine')}
        </Text>
      </View>
